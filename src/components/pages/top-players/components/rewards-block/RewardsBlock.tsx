...
export const RewardsBlock = () => {
  return (
    <button className="fixed bottom-30 right-4 z-50 h-[70px] w-[91px] rounded-xl border border-solid border-black/50 bg-[#6D1F93] pb-1 transition-all active:scale-[0.98]">
