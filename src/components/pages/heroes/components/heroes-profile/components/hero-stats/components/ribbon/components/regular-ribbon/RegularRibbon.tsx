...
export const RegularRibbon = () => (
  <svg
    ...
    viewBox="0 0 110 24"
  >
    <g clipPath="url(#regular-ribbon-a)">
      <g filter="url(#regular-ribbon-b)">
        <path
          fill="#12456F"
    ...
    <defs>
      ...
      >
        ...
        <feBlend
          ...
          result="effect1_dropShadow_6661_5485"
        />
        <feBlend
          in="SourceGraphic"
          in2="effect1_dropShadow_6661_5485"
          result="shape"
        />
      </filter>
    </defs>
